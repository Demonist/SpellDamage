...
function Rogue:init()
	...
	self.spells[703]	= Damage({['ru']=1, ['en']=2, ['de']=3, ['es']=2, ['fr']=2, ['it']=2, ['pt']=2, ['cn']=3, ['tw']=3, ['ko']=3}) 	--Гаррота
	self.spells[1329]	= DamageAndDamage({['ru']={1,2}}) 																				--Расправа
	self.spells[1752]	= Damage({['ru']=1}) 																							--Коварный удар
	self.spells[1943]	= ComboTimeDamage({['ru']={2,3}, ['cn']={3,3}, ['tw']={3,3}, ['ko']={3,3}}) 									--Рваная рана
	...
	self.spells[16511]	= DamageAndTimeDamage({['ru']={1,3}, ['de']={1,4}, ['cn']={1,4}, ['tw']={1,4}, ['ko']={1,4}}, Hemorrhage) 		--Кровоизлияние
	self.spells[26679]	= ComboDamage({['ru']={4,2}})																					--Смертельный бросок
	self.spells[32645]	= ComboTimeDamage({['ru']={3,3}}) 																				--Отравление
	self.spells[51690]	= DamageAndDamage({['ru']={3,4}, ['en']={4,5}, ['de']={4,5}, ['es']={4,5}, ['fr']={4,5}, ['it']={4,5}, ['pt']={4,5}, ['cn']={4,5}, ['tw']={4,5}, ['ko']={4,5}}, KillingSpree) 	--Череда убийств
	self.spells[51723]	= Damage({['ru']=2}) 																							--Веер клинков
	self.spells[73651]	= TimeHeal({['ru']=1, ['de']=2, ['cn']=2, ['tw']=2, ['ko']=2}, Recuperate) 										--Заживление ран
	...
	self.spells[152150]	= Damage({['ru']=1, ['de']=2, ['cn']=2, ['tw']=2, ['ko']=3}, DeathFromAbove) 									--Смерть с небес
end
