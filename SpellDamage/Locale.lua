...
L["macroshelp"] = "For display on macros just add |cFFffff00#sd <id>|r line to macros code. <id> - spell id to be displayed. For example, |cFFffff00#sd 56641|r will display Hunter's 'Steady Shot'. You also can use modifiers, for example, |cFFffff00#sd [mod:shift] 596|r."
...
if locale == "ruRU" then
	...
	L["macroshelp"] = "Для отображение данных на макросах, необходимо в код макроса добавить строчку |cFFffff00#sd <id>|r, где <id> - идентификатор умения, данные которого необходимо отобразить. Например, |cFFffff00#sd 56641|r отобразит 'Верный выстрел' у охотника. Можно использовать модификаторы, например, |cFFffff00#sd [mod:shift] 596|r."
